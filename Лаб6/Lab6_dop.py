...
while flag:
    y = [[4.6 +
          ...
          7.0 * x_nat[i][2] +
          3.9 * x_nat[i][3] +
          1.6 * x_nat[i][1] * x_nat[i][1] +
          0.7 * x_nat[i][2] * x_nat[i][2] +
          0.5 * x_nat[i][3] * x_nat[i][3] +
          9.6 * x_nat[i][1] * x_nat[i][2] +
          0.6 * x_nat[i][1] * x_nat[i][3] +
          2.5 * x_nat[i][2] * x_nat[i][3] +
          3.7 * x_nat[i][1] * x_nat[i][2] * x_nat[i][3]
...
beta0 = (ySr[0] * x_norm[0][0] + ySr[1] * x_norm[1][0] + ySr[2] * x_norm[2][0] + ySr[3] * x_norm[3][0] + x_norm[4][0] *
         ySr[4] +
         x_norm[5][0] * ySr[5] + x_norm[6][0] * ySr[6] + x_norm[7][0] * ySr[7] + ySr[8] * x_norm[8][0] + ySr[9] *
         x_norm[9][
             0] + ySr[10] * x_norm[10][0] + ySr[11] * x_norm[11][0] + x_norm[12][0] * ySr[12] +
         x_norm[13][0] * ySr[13]) / 14
beta1 = (ySr[0] * x_norm[0][1] + ySr[1] * x_norm[1][1] + ySr[2] * x_norm[2][1] + ySr[3] * x_norm[3][1] + x_norm[4][1] *
         ySr[4] +
         x_norm[5][1] * ySr[5] + x_norm[6][1] * ySr[6] + x_norm[7][1] * ySr[7] + ySr[8] * x_norm[8][1] + ySr[9] *
         x_norm[9][
             1] + ySr[10] * x_norm[10][1] + ySr[11] * x_norm[11][1] + x_norm[12][1] * ySr[12] +
         x_norm[13][1] * ySr[13]) / 14
beta2 = (ySr[0] * x_norm[0][2] + ySr[1] * x_norm[1][2] + ySr[2] * x_norm[2][2] + ySr[3] * x_norm[3][2] + x_norm[4][2] *
         ySr[4] +
         x_norm[5][2] * ySr[5] + x_norm[6][2] * ySr[6] + x_norm[7][2] * ySr[7] + ySr[8] * x_norm[8][2] + ySr[9] *
         x_norm[9][
             2] + ySr[10] * x_norm[10][2] + ySr[11] * x_norm[11][2] + x_norm[12][2] * ySr[12] +
         x_norm[13][2] * ySr[13]) / 14
beta3 = (ySr[0] * x_norm[0][3] + ySr[1] * x_norm[1][3] + ySr[2] * x_norm[2][3] + ySr[3] * x_norm[3][3] + x_norm[4][3] *
         ySr[4] +
         x_norm[5][3] * ySr[5] + x_norm[6][3] * ySr[6] + x_norm[7][3] * ySr[7] + ySr[8] * x_norm[8][3] + ySr[9] *
         x_norm[9][
...
if coef.count(0) == 0:
    print('Кількість незначимих коеф.: 0\n')
else:
    print('Незначимі коеф.:')
...
S_ad = (m / (14 - d)) * (pow((yQ[0][0] - ySr[0]), 2) + pow((yQ[1][0] - ySr[1]), 2) + pow((yQ[2][0] - ySr[2]), 2) + pow(
    (yQ[3][0] - ySr[3]), 2)
                         + pow((yQ[4][0] - ySr[4]), 2) + pow((yQ[5][0] - ySr[5]), 2) + pow((yQ[6][0] - ySr[6]),
                                                                                           2) + pow(
...
if adect == 1:
    ...
    Dbeta2 = DB / (14 * m)
    Dbeta = math.sqrt(Dbeta2)
    beta0 = (ySr[0] * x_norm[0][0] + ySr[1] * x_norm[1][0] + ySr[2] * x_norm[2][0] + ySr[3] * x_norm[3][0] + x_norm[4][
        0] * ySr[4] +
             x_norm[5][0] * ySr[5] + x_norm[6][0] * ySr[6] + x_norm[7][0] * ySr[7] + ySr[8] * x_norm[8][0] + ySr[9] *
             x_norm[9][
                 0] + ySr[10] * x_norm[10][0] + ySr[11] * x_norm[11][0] + x_norm[12][0] * ySr[12] +
             x_norm[13][0] * ySr[13]) / 14
    beta1 = (ySr[0] * x_norm[0][1] + ySr[1] * x_norm[1][1] + ySr[2] * x_norm[2][1] + ySr[3] * x_norm[3][1] + x_norm[4][
        1] * ySr[4] +
             x_norm[5][1] * ySr[5] + x_norm[6][1] * ySr[6] + x_norm[7][1] * ySr[7] + ySr[8] * x_norm[8][1] + ySr[9] *
             x_norm[9][
                 1] + ySr[10] * x_norm[10][1] + ySr[11] * x_norm[11][1] + x_norm[12][1] * ySr[12] +
             x_norm[13][1] * ySr[13]) / 14
    beta2 = (ySr[0] * x_norm[0][2] + ySr[1] * x_norm[1][2] + ySr[2] * x_norm[2][2] + ySr[3] * x_norm[3][2] + x_norm[4][
        2] * ySr[4] +
             x_norm[5][2] * ySr[5] + x_norm[6][2] * ySr[6] + x_norm[7][2] * ySr[7] + ySr[8] * x_norm[8][2] + ySr[9] *
             x_norm[9][
                 2] + ySr[10] * x_norm[10][2] + ySr[11] * x_norm[11][2] + x_norm[12][2] * ySr[12] +
             x_norm[13][2] * ySr[13]) / 14
    beta3 = (ySr[0] * x_norm[0][3] + ySr[1] * x_norm[1][3] + ySr[2] * x_norm[2][3] + ySr[3] * x_norm[3][3] + x_norm[4][
        3] * ySr[4] +
             x_norm[5][3] * ySr[5] + x_norm[6][3] * ySr[6] + x_norm[7][3] * ySr[7] + ySr[8] * x_norm[8][3] + ySr[9] *
             x_norm[9][
                 3] + ySr[10] * x_norm[10][3] + ySr[11] * x_norm[11][3] + x_norm[12][3] * ySr[12] +
             x_norm[13][3] * ySr[13]) / 14
    beta4 = (ySr[0] * x_norm[0][4] + ySr[1] * x_norm[1][4] + ySr[2] * x_norm[2][4] + ySr[3] * x_norm[3][4] + x_norm[4][
        4] * ySr[4] +
             x_norm[5][4] * ySr[5] + x_norm[6][4] * ySr[6] + x_norm[7][4] * ySr[7] + ySr[8] * x_norm[8][4] + ySr[9] *
             x_norm[9][
                 4] + ySr[10] * x_norm[10][4] + ySr[11] * x_norm[11][4] + x_norm[12][4] * ySr[12] +
             x_norm[13][4] * ySr[13]) / 14
    beta5 = (ySr[0] * x_norm[0][5] + ySr[1] * x_norm[1][5] + ySr[2] * x_norm[2][5] + ySr[3] * x_norm[3][5] + x_norm[4][
        5] * ySr[4] +
             x_norm[5][5] * ySr[5] + x_norm[6][5] * ySr[6] + x_norm[7][5] * ySr[7] + ySr[8] * x_norm[8][5] + ySr[9] *
             x_norm[9][5]
             + ySr[10] * x_norm[10][5] + ySr[11] * x_norm[11][5] + x_norm[12][5] * ySr[12] +
             x_norm[13][5] * ySr[13]) / 14
    beta6 = (ySr[0] * x_norm[0][6] + ySr[1] * x_norm[1][6] + ySr[2] * x_norm[2][6] + ySr[3] * x_norm[3][6] + x_norm[4][
        6] * ySr[4] +
             x_norm[5][6] * ySr[5] + x_norm[6][6] * ySr[6] + x_norm[7][6] * ySr[7] + ySr[8] * x_norm[8][6] + ySr[9] *
             x_norm[9][
                 6] + ySr[10] * x_norm[10][6] + ySr[11] * x_norm[11][6] + x_norm[12][6] * ySr[12] +
             x_norm[13][6] * ySr[13]) / 14
    beta7 = (ySr[0] * x_norm[0][7] + ySr[1] * x_norm[1][7] + ySr[2] * x_norm[2][7] + ySr[3] * x_norm[3][7] + x_norm[4][
        7] * ySr[4] +
             x_norm[5][7] * ySr[5] + x_norm[6][7] * ySr[6] + x_norm[7][7] * ySr[7] + ySr[8] * x_norm[8][7] + ySr[9] *
             x_norm[9][
    ...
    f4 = 14 - d
    S_ad = (m / (14 - d)) * (
                pow((yQ[0][0] - ySr[0]), 2) + pow((yQ[1][0] - ySr[1]), 2) + pow((yQ[2][0] - ySr[2]), 2) + pow(
            (yQ[3][0] - ySr[3]), 2)
    ...
    beta7 = (ySr[0] * x_norm[0][7] + ySr[1] * x_norm[1][7] + ySr[2] * x_norm[2][7] + ySr[3] * x_norm[3][7] + x_norm[4][
        7] * ySr[4] +
             ...
             x_norm[9][
                 7] + ySr[10] * x_norm[10][7] + ySr[11] * x_norm[11][7] + x_norm[12][7] * ySr[12] +
             x_norm[13][7] * ySr[13]) / 14
    beta8 = (ySr[0] * x_norm[0][8] + ySr[1] * x_norm[1][8] + ySr[2] * x_norm[2][8] + ySr[3] * x_norm[3][8] + x_norm[4][
        8] * ySr[4] +
             x_norm[5][8] * ySr[5] + x_norm[6][8] * ySr[6] + x_norm[7][8] * ySr[7] + ySr[8] * x_norm[8][8] + ySr[9] *
             x_norm[9][
                 8] + ySr[10] * x_norm[10][8] + ySr[11] * x_norm[11][8] +
             x_norm[12][8] * ySr[12] +
             x_norm[13][8] * ySr[13]) / 14
    beta9 = (ySr[0] * x_norm[0][9] + ySr[1] * x_norm[1][9] + ySr[2] * x_norm[2][9] + ySr[3] * x_norm[3][9] + x_norm[4][
        9] * ySr[4] +
             x_norm[5][9] * ySr[5] + x_norm[6][9] * ySr[6] + x_norm[7][9] * ySr[7] + ySr[8] * x_norm[8][9] + ySr[9] *
             x_norm[9][
                 9] + ySr[10] * x_norm[10][9] + ySr[11] * x_norm[11][9] + x_norm[12][9] * ySr[12] +
             x_norm[13][9] * ySr[13]) / 14
    beta10 = (ySr[0] * x_norm[0][10] + ySr[1] * x_norm[1][10] + ySr[2] * x_norm[2][10] + ySr[3] * x_norm[3][10] +
              x_norm[4][
                  10] * ySr[4] +
              x_norm[5][10] * ySr[5] + x_norm[6][10] * ySr[6] + x_norm[7][10] * ySr[7] + ySr[8] * x_norm[8][10] + ySr[
                  9] * x_norm[9][
